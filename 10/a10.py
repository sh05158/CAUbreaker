...
print(os.getcwd())
fname_data_train    = '10/assignment_10_data_train.csv'
fname_data_test     = '10/assignment_10_data_test.csv'
...
while True:
    ...
    acc1 = accuracy_iteration_train[-1]
    acc2 = accuracy_iteration_test[-1]
